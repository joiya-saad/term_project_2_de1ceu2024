...
- An AWS account was created for the extracting, wrangling, storing, manipulating and serving the datasets that are used in the project.
...
- Once Sagemaker was able to access S3 bucket, we used Jupyter Notebooks to access the files and wrangled them using python. 
